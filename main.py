...
class ContactBook:
    ...
    def instructions(self):
        ...
        Используйте название.seeAll() для просмотра всех контактов.
          
        Используйте название.addContact('имя','адрес','номер телефона','эл. почта') для добавления контакта.
        Внимание! Все значения, указанные в скобках, должны быть в кавычках!
        
        Используйте название.redact(порядковый номер контакта,порядковый номер данных,'новые данные')
        для редактироания ваших контактов.
        
        Используйте название.delete(Порядковый номер контакта), чтобы удалить контакт.
        
        Используйте название.clear(), чтобы полностью очистить книгу.
        
        Используйте название.sort(), чтобы отсортировать контакты в порядке ASCII.
        ''')
    ...
    def redact(self,contactNumber,propertyNumber,NewProperty):
        ...
        try:
            if propertyNumber == 1:
                ...
                cursorObject.execute("UPDATE contacts SET phonenumber=? WHERE phonenumber=?",[phonenumber,newPhonenumber])
